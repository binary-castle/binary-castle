...
<template>
  <div class="bg-about">
    <div class="container">
      <div class="row py-5">
        <div class="col-md-6">
          <div class="bg-white" style="margin-top: 200px;">
            <h2>
              Grow your Business & <br> Customer Satisfaction with <span>{;}BinaryCastle</span>
            </h2>
            <p>Dynamically disintermediate technically sound technologies with compelling quality vectors error-free
              communities.</p>
            <div class="d-flex gap-4">
              <NuxtLink class="btn btn-primary btn-lg" to="/career">Open Positions</NuxtLink>
              <NuxtLink class="btn btn-secondary btn-lg" to="/team">Meet Our Team</NuxtLink>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="687.80201" viewBox="0 0 821.16801 687.80201"
            ...
            <polygon points="755.994 674.556 743.734 674.555 737.902 627.268 755.996 627.268 755.994 674.556"
                     fill="#9e616a"/>
            <path d="M948.53667,792.539l-39.53076-.00146v-.5a15.3873,15.3873,0,0,1,15.38647-15.38623h.001l24.144.001Z"
            ...
            <polygon points="708.994 674.556 696.734 674.555 690.902 627.268 708.996 627.268 708.994 674.556"
                     fill="#9e616a"/>
            <path d="M901.53667,792.539l-39.53076-.00146v-.5a15.3873,15.3873,0,0,1,15.38647-15.38623h.001l24.144.001Z"
                  transform="translate(-189.41599 -106.099)" fill="#2f2e41"/>
            <path id="ae5c11dc-7e77-468a-a39f-cc8da6ee1565-1123" data-name="Path 1495"
            ...
            <path id="bc696f83-47b6-45c9-967f-bb64f1f3bee5-1124" data-name="Path 1496"
            ...
            <circle id="a7ca0488-8ee6-49e2-b245-2872b84c042e" data-name="Ellipse 304" cx="717.832" cy="236.535" r="28"
                    fill="#6c63ff"/>
            <path id="b579ef19-595a-43de-9b6d-0ead8268ca48-1125" data-name="Path 1507"
                  ...
                  transform="translate(-189.41599 -106.099)" fill="#3f3d56"/>
            <path id="b3465432-03e0-48eb-8016-b04aa244e72c-1126" data-name="Path 1513"
                  d="M758.748,790.554V352.8c0-5.614,3.949-10.166,8.82-10.166h39.36c4.871,0,8.82,4.551,8.82,10.166V791.7Z"
                  transform="translate(-189.41599 -106.099)" fill="#3f3d56"/>
            <path id="ac7870c5-efcc-4c4b-b17f-07e0bff4d096-1127" data-name="Path 1508"
            ...
            <path id="be4b35b3-6955-40b7-9549-45fdba6a2930-1128" data-name="Path 1509"
            ...
            <circle id="a7d383a2-21d6-4551-be8a-8c82a5e576cb" data-name="Ellipse 307" cx="708.75198" cy="314.48401"
                    r="20.75" fill="#9e616a"/>
            <path id="fb091cb1-8ad4-4d57-b74d-c940c723d6bf-1129" data-name="Path 1512"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="row">
            <div class="col-6 text-center border p-5">
              <h1>250+</h1>
        ...
        <div class="col-md-6">
          <p>Our Story</p>
          <h3>A Great Story Starts with a Friendly Team</h3>
          <p>Globally e-enable principle-centered e-business before dynamic quality vectors cross-media materials before
            proactive outsourcing leverage other's vertical technology leadership.</p>
        </div>
      </div>
    </div>
